        ...
        return __generator(this, function (_a) {
            ...
            if (kurralJson && kurralJson && kurralJson.length) {
                ...
                if (thrikurralList && thrikurralList.length) {
                    return [2 /*return*/, storage_1.createKurral(thrikurralList)];
                }
                else {
                    return [2 /*return*/, storage_1.error(400, "Invalid Request. KurralCreation request is empty")];
                }
            }
            else {
